...
public class LogicModel {
    public static void main(String[] args) {
        ...
        Expression c4 = exprFact.createOperator(ExpressionFactory.OperatorType.IMPLICATION, p1,q1);
        Expression c5 = exprFact.createOperator(ExpressionFactory.OperatorType.IMPLICATION, r1,q1);
        Expression c6 = exprFact.createOperator(ExpressionFactory.OperatorType.DISJUNCTION, p1,r1);
        Expression c7 = exprFact.createOperator(ExpressionFactory.OperatorType.CONJUNCTION, c4,c5);
        ...
        Collection<ExpressionFactory.RuleType> col1 = exprFact.checkLegalRules(c1);
        //col.forEach((type) -> System.out.println(type));
        for (ExpressionFactory.RuleType type : col1) {
        ...
        Collection<ExpressionFactory.RuleType> col2 =exprFact.checkLegalRules(c6,c7);
        for (ExpressionFactory.RuleType type : col2) {
            System.out.println(type);
        }
